...
export const Full_Leave = ({ navigation }: any) => {
    ...
    const full_press_back = () => {
        navigation.navigate("Sales Marketing");
    }

    const validation_full_leave = () => {
        let isValid = false;
        let error = {};
    ...
    const full_leave_submit = async () => {
        const { isValid, error }: any = validation_full_leave();
        Seterrors(error);
        ...
        formData.append("leave_day", "Full");
    ...
    return (
        ...
        <SafeAreaView style={{ height: "100%", backgroundColor: 'white' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: "3%", marginBottom: "3%" }}>
                <View style={{ width: "15%" }}>
                    <TouchableOpacity onPress={full_press_back}>
                ...
                <View style={{ width: "75%", alignItems: 'center' }}>
                    <Text style={{ color: '#247401', fontSize: 20, fontWeight: 'bold', fontFamily: 'Montserrat' }}>Full Leave</Text>
                </View>
            </View>
            ...
            <ScrollView>
                <View>
                    ...
                    {/* REASON FIELD */}
                    <View style={{ marginLeft: 20, marginRight: 20, marginTop: 10 }}>
                        <View style={{ width: "100%", height: "auto", minHeight: 60, borderWidth: errors?.content ? 2 : 1, marginTop: 20, borderColor : errors?.content ? 'red' : 'black' }}>
                            <View style={{ position: 'absolute', top: -8, left: 17 }}>
                    ...
                    {/* BUTTON */}
                    <View>
                        <TouchableOpacity style={styles.submit} onPress={full_leave_submit}>
...
{/* <View style={{borderWidth: 1, borderRadius: 6, borderColor:'#D9D9D9', backgroundColor:'#FFF'}}>
